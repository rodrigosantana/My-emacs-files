;;; color-theme-julie.el --- A color theme for Emacs.
...
(defvar julie-fg        "#698b22")


(defvar julie-bg-1      "#101010")
(defvar julie-bg        "#151515")
(defvar julie-bg+1      "#202020")
(defvar julie-bg+2      "#505050")
(defvar julie-bg-marrom      "#151515")

(defvar julie-red+1     "#8d4a4a")
(defvar julie-red       "#953331")
(defvar julie-red-1     "#953331")
(defvar julie-yano-red  "#EE6363")
(defvar julie-red-yano  "#ff0000")

(defvar julie-orange    "#ff8939")

(defvar julie-yellow    "#909737")
(defvar julie-yellow-1  "#909737")

(defvar julie-green-1   "#546a29")
(defvar julie-green     "#546a29")
(defvar julie-green+1   "#7e9960")
(defvar julie-yano      "Chartreuse1")
...
(defvar julie-yano-blue "#836fff")

(defvar julie-magenta   "#7f355e")
(defvar yano-purple     "#551a8b")
(defvar yano-rowybrown  "#bc8f8f")
(defvar yano-sienna     "#a0522d")
(defvar yano-saddle     "#8b4513")
(defvar yano-darkkaki   "#bdb76b")
...
(defun color-theme-julie ()
  (interactive)
  (color-theme-install
   `(color-theme-julie
     ;;; color-theme mapping
     ((foreground-color . ,julie-fg)
      (background-color . ,julie-bg-marrom)
     ...
     ;;; basic coloring
     (default ((t (:foreground ,julie-fg))))
     (cursor
      ((t (:foreground ,julie-fg))))
     ...
     ;;; font lock
     (font-lock-builtin-face ((t (:foreground ,julie-red))))
     (font-lock-comment-face ((t (:foreground ,julie-yano-red))))
     (font-lock-comment-delimiter-face ((t (:foreground ,julie-bg+2))))
     (font-lock-constant-face ((t (:foreground ,julie-yano))))
     (font-lock-doc-face ((t (:foreground ,julie-green+1))))
     (font-lock-doc-string-face ((t (:foreground ,julie-blue+1))))
     (font-lock-function-name-face ((t (:foreground ,julie-green+1))))
...
;;; color-theme-julie.el ends here.
