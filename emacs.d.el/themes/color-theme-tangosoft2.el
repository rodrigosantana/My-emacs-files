;; source --> https://github.com/vic/color-theme-select/tree/master/site-lisp/themes/featured

;; requires
(require 'color-theme)

(defun color-theme-tangosoft2 ()
  ...
  (color-theme-install
   '(color-theme-tangosoft
     ...
     (which-func ((t (:bold t :foreground "#edd400" :my-flag t))))
     )))

(put 'which-func 'init-flag t)

(add-to-list 'color-themes '(color-theme-tangosoft2
                             "tangosoft2"
                             "Victor Hugo Borja <vborja@apache.org"))


(provide 'color-theme-tangosoft2)
