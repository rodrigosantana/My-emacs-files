...
(defvar yano-darkkaki   "#bdb76b")
  ...
  (color-theme-install
   '(color-theme-tangosoft
     ...
     (font-lock-comment-face ((t (:foreground "#505050" :italic t))))
     (font-lock-comment-delimiter-face ((t (:foreground "#505050":bold t))))	
     (font-lock-constant-face ((t (:foreground "Chartreuse1"))))
     (font-lock-doc-face ((t (:foreground "#888a85"))))
     (font-lock-keyword-face ((t (:foreground "#729fcf" :bold t))))
     (font-lock-string-face ((t (:foreground "#EE6363" :bold t))))
